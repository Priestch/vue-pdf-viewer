...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pdfCustomViewer"] = factory();
	else
		root["pdfCustomViewer"] = factory();
...
{
  exports.pdfjsWebApp = pdfjsWebApp = __webpack_require__(4);
}
;
{
...
function getViewerConfiguration() {
  return {
    appContainer: document.getElementById('pdfAppContainer'),
...
var pdfViewer = {
  ...
  loadPDF: function loadPDF(pdfURL) {
    this.config = getViewerConfiguration();
    this.config.defaultUrl = pdfURL;
    window.PDFViewerApplication = pdfjsWebApp.PDFViewerApplication;
    pdfjsWebApp.PDFViewerApplication.run(this.config);
  }
};
